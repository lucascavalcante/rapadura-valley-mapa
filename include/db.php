...
// The <title></title> tag
$title_tag = "Rapadura Valley - Mapa da comunidade de startups de Fortaleza";

// The latitude & longitude to center the initial map
$lat_lng = "-3.73186,-38.52667";

// Domain to use for various links
$domain = "http://www.rapaduravalley.org";

// Twitter username and default share text
$twitter = array(
  "share_text" => "Cadastre sua empresa na comunidade de startups de Fortaleza! #rapaduravalley",
  "username" => ""
);

// Short blurb about this site (visible to visitors)
$blurb = "Este mapa foi idealizado para conectar e promover a comunidade de startups de Fortaleza. Vamos colocar Fortal no cen&aacute;rio nacional das startups!";

// attribution (must leave link intact, per our license)
$attribution = "
  <span>
    Mapa baseado no <a href='http://www.represent.la' target='_blank'>RepresentLA</a>
  </span>
";
...
if($sg_enabled) {
  $attribution .= "
    <br /><br />
    Dados do <a target='_blank' href='http://www.startupgenome.com'>StartupGenome</a>
  ";
}
?>
