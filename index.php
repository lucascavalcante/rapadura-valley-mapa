    ...
    <div class="topbar" id="topbar">
      <div class="wrapper">
        ...
        <div class="left">
          <div class="logo">
            <a href="./">
              <img src="images/rv-logo.png" alt="" />
            </a>
          </div>
          <div class="buttons">
            <!--<a href="#modal_info" class="btn btn-large btn-info" data-toggle="modal"><i class="icon-info-sign icon-white"></i>About this Map</a>-->
            <?php if($sg_enabled) { ?>
              <a href="#modal_add_choose" class="btn btn-large btn-success" data-toggle="modal"><i class="icon-plus-sign icon-white"></i>Adicione sua Empresa</a>
            <? } else { ?>
              <a href="#modal_add" class="btn btn-large btn-success" data-toggle="modal"><i class="icon-plus-sign icon-white"></i>Adicione sua Empresa</a>
            <? } ?>
          </div>
          <div class="search">
            <input type="text" name="search" id="search" placeholder="Procurar empresas..." data-provide="typeahead" autocomplete="off" />
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="modal hide" id="modal_add">
      <form action="add.php" id="modal_addform" class="form-horizontal">
          ...
          <fieldset>
            ...
            <div class="control-group">
              ...
              <div class="controls">
                <select name="type" id="add_type" class="input-xlarge">
                  ...
                  <option value="service">Consultoria</option>
            ...
            <div class="control-group">
              ...
              <div class="controls">
                ...
                <p class="help-block">
                  Coloque o <b>endereço completo (incluindo cidade e CEP)</b>. Se funciona no Google Maps, vai funcionar aqui.
                </p>
              </div>
            </div>
            <div class="control-group">
              ...
              <div class="controls">
                ...
                <p class="help-block">
                  Deve ser a URL completa, sem a barra no final. Por exemplo: http://www.seusite.com
                </p>
              </div>
            </div>
            <div class="control-group">
              ...
              <div class="controls">
                ...
                <p class="help-block">
                  Descrição breve e concisa. Qual o seu produto? Quais problemas ele resolve? (máx. 150 caracteres)
                </p>
              </div>
            </div>
          </fieldset>
        ...
        <div class="modal-footer">
          ...
          <a href="#" class="btn" data-dismiss="modal" style="float: right;">Sair</a>
        </div>
      </form>
    </div>
    <script>
      ...
      $("#modal_addform").submit(function(event) {
        ...
        $.post( url, { owner_name: owner_name, owner_email: owner_email, title: title, type: type, address: address, uri: uri, description: description },
          function( data ) {
            ...
            if(data == "success") {
              $("#modal_addform #result").html("Seu cadastro foi enviado para aprovação. Obrigado!");
